...
public class ArraysListPracticeDemo {
    public static void main(String[] args) {
        ...
        lst.sort( Comparator.naturalOrder() ); //[Arya Stark, Jon Snow, Sansa Stark]
        System.out.println("After Sorting in low to high (natural) order = \n\t" + lst);
        lst.sort( Comparator.reverseOrder() ); //[Sansa Stark, Jon Snow, Arya Stark]
        ...
        Arrays.sort( arrOutOfList,Comparator.reverseOrder() ); //[Sansa Stark, Jon Snow, Arya Stark]
