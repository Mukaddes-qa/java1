...
//                            " Car Model is " + eachCarSplitted[1]   );
        ...
        // find all the car with model has only 2 caharacters
        // print them out get the count

        int count2Character=0;
        for (String eachCar : cars) {
        ...
        System.out.println("Car Count with 2 Character "+count2Character);
        ...
        Arrays.sort(cars);
        System.out.println(" Car = " + Arrays.toString(cars) );
    }
