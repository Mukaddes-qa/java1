...
public class SplitAndInitial {
    public static void main(String[] args) {
        String hero1 = "Super- Clark J Kent";
        // Task :
        ...
        //       then get the letter after space
        //       concatenate them
       ...
       /* Last character of any String -->> str.charAt( str.length()-1  )
        ...
        // get the first character the concatenate
        ...
        // last name will be last element of splitted full name
